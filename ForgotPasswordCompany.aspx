<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPasswordCompany.aspx.cs" Inherits="workHub.ForgotPasswordCompany" %>
        ...
        <div class="container">
            <div class="form-container">
                <div class="left-section">
                    <a class="back-btn" href="LoginCompany.aspx">Back to Login</a>
                    <h1>Reset Your Password</h1>
                    <p>Enter your company details to reset your password.</p>
                </div>
                <div class="right-section">
                    ...
                    <div class="form-group" id="emailSection" runat="server">
                        <label for="txtEmail">Company Email Address *</label>
